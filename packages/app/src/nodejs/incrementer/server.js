...
var PROTO_PATH = __dirname + '/incrementer.proto'
...
var incrementer = protoDescriptor.incrementer
...
function getServer() {
  ...
  server.addService(incrementer.Greeter.service, {
    sayHello: doSayHello,
    sayRepeatHello: doSayRepeatHello,
    sayHelloAfterDelay: doSayHelloAfterDelay,
  })
  server.dothatthingyoudo = () => {
    server.bind('0.0.0.0:9090', grpc.ServerCredentials.createInsecure())
    server.start()
    console.log('grpc server is running on 0.0.0.0:9090')
  }
  return server
}
